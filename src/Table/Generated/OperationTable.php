...
class OperationTable extends \PSX\Sql\TableAbstract
{
    ...
    public const COLUMN_RESPONSE_HEADERS = 'response_headers';
     ...
     * @throws \PSX\Sql\Exception\QueryException
     */
    public function findByResponseHeaders(string $value, ?int $startIndex = null, ?int $count = null, ?string $sortBy = null, ?\PSX\Sql\OrderBy $sortOrder = null) : array
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('response_headers', $value);
        return $this->doFindBy($condition, $startIndex, $count, $sortBy, $sortOrder);
    }
    /**
     * @throws \PSX\Sql\Exception\QueryException
     */
    public function findOneByResponseHeaders(string $value) : ?\Fusio\Impl\Table\Generated\OperationRow
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('response_headers', $value);
        return $this->doFindOneBy($condition);
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function updateByResponseHeaders(string $value, \Fusio\Impl\Table\Generated\OperationRow $record) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('response_headers', $value);
        return $this->doUpdateBy($condition, $record->toRecord());
     ...
     * @throws \PSX\Sql\Exception\ManipulationException
     */
    public function deleteByResponseHeaders(string $value) : int
    {
        $condition = \PSX\Sql\Condition::withAnd();
        $condition->like('response_headers', $value);
        return $this->doDeleteBy($condition);
