...
/**
 * Extended Operation model (ships with fusio-impl) adding {@see self::$usability}.
 * Overrides apioo/fusio-model class via composer autoload path order.
 */
...
class Operation implements \JsonSerializable, \PSX\Record\RecordableInterface
{
    ...
    #[Description('0 = validate with Fusio token and scopes (internal), 1 = validate Bearer token against the configured user center (external)')]
    protected ?int $usability = null;
    ...
    public function toRecord(): \PSX\Record\RecordInterface
    {
        ...
        $record->put('usability', $this->usability ?? OperationTable::USABILITY_INTERNAL);
